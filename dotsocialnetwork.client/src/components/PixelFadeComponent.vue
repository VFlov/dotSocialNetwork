  ...
  export default {
    components: {
      PixelCanvas: {
        ...
        computed: {
          colors() {
            return this.dataColors?.split(",") || ["#f8fafc", "#f1f5f9", "#cbd5e1"];
          },
          gap() {
            const value = this.dataGap;
            const min = 4;
            const max = 50;
        ...
        mounted() {
          ...
          if (!this.noFocus) {
            this._parent.addEventListener("focusin", this.onFocusIn);
            this._parent.addEventListener("focusout", this.onFocusOut);
          }
        ...
        beforeUnmount() {
          ...
          if (!this.noFocus) {
            this._parent.removeEventListener("focusin", this.onFocusIn);
            this._parent.removeEventListener("focusout", this.onFocusOut);
          }
